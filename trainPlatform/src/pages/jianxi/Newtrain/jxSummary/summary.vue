  ...
  <div>
    ...
    <div v-if="listView == 2">
      ...
      <el-table key='mytable' :data="tableData" style="width: 100%;margin-top: 10px">
        ...
        <el-table-column label="见习" width="360">
          <template slot-scope="scope">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getdata: function () {
                let that = this
                this.$http.post('/probation/assess/getdata2', { recruitId: this.row.id }).then(function (res) {
                ...
                this.$http.post('/probation/remind/getremind2', { recruitId: this.row.id }).then(function (res) {
            ...
            handleCheckedDaysChange (value) {
                ...
                let that = this
                this.$http.post('/probation/remind/addremind2', { form: this.form, recruitId: this.row.id }).then(function (res) {
                    that.tableData = res.data.data
                    console.log(res.data.data)
                })
            },
            ensure2 () {
                ...
                let that = this
                this.$http.post('/probation/remind/editremind2', { form: this.form2, recruitId: this.row.id }).then(function (res) {
                    that.tableData = res.data.data
                    console.log(res.data.data)
                })
            }
