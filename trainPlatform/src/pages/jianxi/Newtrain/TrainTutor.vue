    ...
    <div v-if="view == 1">
      <div v-show="!tabvisible">
        <el-tabs v-model="activeNow" @tab-click="handleClick">
          <el-tab-pane label="进行中" name="first"><TuOngoing :ondata="ondata" v-on:ongoingchild="listenOn"></TuOngoing></el-tab-pane>
          <el-tab-pane label="已结束" name="second"><TuComplete :compdata="compdata" v-on:compeletechild="listenComp"></TuComplete></el-tab-pane>
        </el-tabs>
      </div>
      <div v-if="tabvisible">
...
<script>
    import TuOngoing from './TuOngoing'
    import TuComplete from './TuComplete'
    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                let that = this
                this.$http.post('/probation/novitiate/traindata', {power: this.power}).then(function (res) {
