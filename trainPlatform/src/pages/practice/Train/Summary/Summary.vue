...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getdata: function () {
        let that = this
        this.$http.post('/practice/evaluate/getdata2', { recruitId: this.row.id }).then(function (res) {
        ...
        this.$http.post('/practice/remind/getremind2', { recruitId: this.row.id }).then(function (res) {
      ...
      summaryView: function (index) {
        ...
        let that = this
        that.$http.post('/practice/evaluate/endsummary', {
          stuId: that.stuId
        }).then((res) => {
      ...
      submit: function (index, evaluate, flag) {
        this.$http.post('/practice/evaluate/insertsummary', {
      ...
      evaluate: function (evaluate, flag) {
        let that = this
        that.$http.post('/practice/evaluate/insertevaluate', {
          stuId: that.stuId,
          evaluate: evaluate,
          flag: flag
        }).then((res) => {
      ...
      exportWd () {
        this.$http.post('/practice/export/sumword', { stu: this.summary, summary: this.summaryContent }).then(function (res) {
      ...
      handleCheckedDaysChange (value) {
        ...
        let that = this
        this.$http.post('/practice/remind/addremind2', { form: this.form, recruitId: this.row.id }).then(function (res) {
          that.tableData = res.data.data
          console.log(res.data.data)
        })
      },
      ensure2 () {
        ...
        let that = this
        this.$http.post('/practice/remind/editremind2', { form: this.form2, recruitId: this.row.id }).then(function (res) {
          that.tableData = res.data.data
          console.log(res.data.data)
        })
      }
