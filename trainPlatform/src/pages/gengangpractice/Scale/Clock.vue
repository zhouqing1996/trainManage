  ...
  export default {
    ...
    methods: {
      ...
      search () {
        ...
        let that = this
        this.$http.post('/gengangpractice/clock/clocklist', { date: this.form.date, sno: this.form.sno, class: this.class, power: this.power, user: this.$store.state.mutations.user }).then(function (res) {
    ...
    mounted () {
      let that = this
      this.$http.post('/gengangpractice/clock/getclass', {power: this.power, user: this.$store.state.mutations.user}).then(function (res) {
