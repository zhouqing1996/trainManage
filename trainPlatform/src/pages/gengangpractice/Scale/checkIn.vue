    ...
    export default {
      ...
      methods: {
        ...
        search () {
          ...
          let that = this
          this.$http.post('/gengangpractice/clock/clocklist', { date: this.form.date, sno: this.form.sno, class: this.class }).then(function (res) {
      ...
      mounted () {
        let that = this
        this.$http.post('/gengangpractice/clock/getclass').then(function (res) {
