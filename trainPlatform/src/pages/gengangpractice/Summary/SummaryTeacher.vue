  ...
  const cityOptions = ['周一', '周二', '周三', '周四', '周五', '周六', '周日']
    export default {
      ...
      methods: {
        ...
        getdata: function () {
          let that = this
          this.$http.post('/gengangpractice/evaluate/getdata').then(function (res) {
            console.log(111)
          ...
          this.$http.post('/gengangpractice/remind/getremind').then(function (res) {
        ...
        handleCheckedDaysChange (value) {
          ...
          let that = this
          this.$http.post('/gengangpractice/remind/addremind', { form: this.form }).then(function (res) {
            that.tableData = res.data.data
            console.log(res.data.data)
          })
        },
        ensure2 () {
          ...
          let that = this
          this.$http.post('/gengangpractice/remind/editremind', { form: this.form2 }).then(function (res) {
            that.tableData = res.data.data
            console.log(res.data.data)
          })
        },
