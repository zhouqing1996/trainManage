  ...
  export default {
    ...
    methods: {
      ...
      search () {
        ...
        let that = this
        this.$http.post('/gengangpractice/clock/clocklist2', { date: this.form.date, sno: this.form.sno, rowId: this.row.id }).then(function (res) {
    ...
    mounted () {
      ...
      let that = this
      this.$http.post('/gengangpractice/clock/getclass', {power: this.power, recruitId: this.row.id}).then(function (res) {
