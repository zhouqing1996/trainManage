...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData () {
        let that = this
        this.$http.post('/gengangpractice/recruitment/data', {power: this.$store.getters.showPower}).then(function (res) {
      ...
      dateEnsure () {
        ...
        let that = this
        this.$http.post('/gengangpractice/recruitment/modifystatus', { id: this.row.id, status: 1, date: this.studentEnddate }).then(function (res) {
          if (res.data.data == 1) {
            that.getData()
      ...
      handleCancel (index, row) {
        let that = this
        this.$http.post('/gengangpractice/recruitment/modifystatus', { id: row.id, status: 2 }).then(function (res) {
          if (res.data.data == 1) {
            that.getData()
            common.$emit('change', '信息已修改！')
          }
      ...
      edit (index, row) {
        if (row.status == 0) {
          ...
          let that = this
          this.$http.post('/gengangpractice/recruitment/gettstudent', { id: row.id }).then(function (res) {
      ...
      ensureArran () {
        let that = this
        this.$http.post('/gengangpractice/recruitment/arrangest', { id: this.form.id, student: this.form.student }).then(function (res) {
          that.arrange = 0
          that.getData()
          common.$emit('change', '信息已修改！')
          console.log(res.data.data)
      ...
      getApplystu(data) {
        ...
        let that = this
        this.$http.post('/gengangpractice/recruitment/getapplystu', { id: id }).then(function (res) {
    ...
    mounted () {
      this.getData()
      let that = this
      this.$http.post('/gengangpractice/recruitment/getteacher').then(function (res) {
        console.log(res.data)
